...
import com.labs.jangkriek.carilahan.Activity.LogInSignUp.LoginFragment.LoginUserFragment;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFragment(new LoginUserFragment(), "User");
        adapter.addFragment(new LoginAdminFragment(), "Admin");
